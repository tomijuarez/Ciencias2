...
//para probar el algoritmo de impresion del arbol
...
void RefutationTree::drawingTree(QQueue<std::string> Q,TreeAux &  TernaryTree){
    ...
    while(!cola.empty())
    {
        ...
        if(form.getType() == 2)
        {
          ...
          TernaryTree.addFormulas(2,operantOne,operantTwo,previousFormula,E);
        ...
        else if(form.getType() == 1)
        {
            ...
            TernaryTree.addFormulas(1,operantOne,operantTwo,previousFormula,E);
